...
if(isset($_POST['submit'])){
    if(empty($_POST['username']) || empty($_POST['password'])){
        ...
        $sql = "SELECT * FROM donation_receiver WHERE username='$username' AND password='$password'";
...
<html class="no-js">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="has-child"><a href="#">MEDICAL</a>
                      ...
                      <ul class="submenu">
                         <li class="submenu-item"><a href="education-donation.html">Education </a></li>
                         <li class="submenu-item"><a href="medical-donation.html">Medical </a></li>
                         <li class="submenu-item"><a href="food-donation.html">Food </a></li>
                        <li class="submenu-item"><a href="business-donation.html">Business </a></li> 
                      </ul>
    ...
    <div class="form">
        <form class="register-form" method="post" action="donation-receiver-registration.php">
        ...
        <form class="log-in form" method="post" action="donation-receiver.php">
        <input type="text" name="username" placeholder="user name"/>
